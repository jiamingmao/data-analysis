# Homework Challenge (Discrete Choice Problem)
...
While there is a long list of literature, here is a simple introduction to the estimation of static discrete games: [Ellickson & Misra (2011)]().
