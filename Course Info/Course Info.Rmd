...
- Methods are demonstrated with applications to actual and simulated problems in applied microeconomics.
...
- You are expected to have some familiarity with <u>at least one</u> programming/statistical computing language. 
